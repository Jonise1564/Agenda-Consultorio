...
class AuthController {
    ...
    login = async (req, res) => {
        ...
        try {
            ...
            // 1: Admin, 2: Médico, 3: Secretaria, 4: Paciente
            // =====================================================
            if (usuario.id_rol === 2) {
                return res.redirect('/medicos/dashboard'); 
            } else if (usuario.id_rol === 3) {
                return res.redirect('/secretaria');
            } else {
                return res.redirect('/'); // Admin y Pacientes al inicio
            }
    ...
    #generarToken(usuario) {
        // Se añade id_medico al payload del JWT para validaciones de propiedad de turnos
        return jwt.sign(
            {
                id: usuario.id,
                id_rol: usuario.id_rol,
                id_persona: usuario.id_persona,
                id_medico: usuario.id_medico || null, // VITAL para el bloqueo en controladores
