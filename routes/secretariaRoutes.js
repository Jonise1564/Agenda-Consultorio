...
// // --- DEFINICIÓN DE RUTAS (SECRETARÍA GENERAL) ---
...
// // --- NUEVA: Verificación de duplicados (AJAX para el PUG) ---
// // Esta es la que llama el script del PUG para bloquear el botón
...
// // IMPORTANTE: El export siempre al final de todas las rutas
...
// NUEVA: Vista de gestión de todos los turnos (La tabla celeste con filtros)
router.get('/turnos', (req, res, next) => SecretariaController.verListaTurnos(req, res, next));

// NUEVA: Acción de transferir/mover pacientes entre agendas
...
// IMPORTANTE: El export siempre al final
module.exports = router;