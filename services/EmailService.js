...
const enviarConfirmacion = async (emailPaciente, datos) => {
    ...
    // Generación de archivo de invitación .ics para el calendario
...
const enviarRecordatorio24hs = async (emailPaciente, datos) => {
    const mailOptions = {
        ...
        html: `
            <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 500px; margin: auto; border: 1px solid #ffc107; border-radius: 12px; overflow: hidden; background-color: #ffffff;">
                <div style="background-color: #ffc107; padding: 20px; text-align: center;">
                    <h2 style="color: #333; margin: 0; font-size: 20px;">⏰ Recordatorio de Turno</h2>
                </div>
                ...
                <div style="padding: 30px; color: #444; line-height: 1.6;">
                    ...
                    <div style="text-align: center; margin: 25px 0;">
                        <a href="${datos.linkUbicacion}" target="_blank" style="display: block; padding: 14px; background-color: #4285F4; color: white; text-decoration: none; border-radius: 8px; font-weight: bold; margin-bottom: 10px;">📍 Cómo llegar (Google Maps)</a>
                        <a href="${datos.linkWhatsapp}" target="_blank" style="display: block; padding: 14px; background-color: #25D366; color: white; text-decoration: none; border-radius: 8px; font-weight: bold;">💬 Consultas por WhatsApp</a>
                    </div>

                    <p style="font-size: 13px; color: #666; text-align: center;">Si no puedes asistir, por favor contáctanos a la brevedad.</p>
                </div>
            </div>
        `
    };
